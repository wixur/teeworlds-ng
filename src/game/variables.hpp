...
MACRO_CONFIG_INT(cl_camera_dynamic, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dynamic camera")
...
MACRO_CONFIG_INT(cl_dynamic_camera_key, 0, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dynamic camera by key")
